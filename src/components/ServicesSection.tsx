            ...
            {aiServices.map((service, i) => (
              <ScrollReveal key={service.title} delay={i * 0.08}>
                {(() => {
                  ...
                  const hasBackground = isMarketing || isOperations || isSupport || isAccounting;
                  const bgImage = isMarketing ? aiMarketingBg : isOperations ? aiOperationsBg : isSupport ? aiSupportBg : isAccounting ? aiAccountingBg : undefined;
                  return (
                    <motion.div
