            ...
            {talentServices.map((service, i) => (
              <ScrollReveal key={service.title} delay={i * 0.08}>
                {(() => {
                  ...
                  const hasTalentBg = isMarketingTeam || isOpsTeam || isHelpdesk || isAccounting;
                  const talentBgImage = isMarketingTeam ? talentMarketingBg : isOpsTeam ? talentOperationsBg : isHelpdesk ? talentHelpdeskBg : isAccounting ? talentAccountingBg : undefined;
                  return (
                    <motion.div
