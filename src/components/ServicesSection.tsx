            ...
            {aiServices.map((service, i) => (
              <ScrollReveal key={service.title} delay={i * 0.08}>
                {(() => {
                  ...
                  const hasBackground = isMarketing || isOperations || isSupport || isAccounting || isHR;
                  const bgImage = isMarketing ? aiMarketingBg : isOperations ? aiOperationsBg : isSupport ? aiSupportBg : isAccounting ? aiAccountingBg : isHR ? aiHrBg : undefined;
                  return (
                    <motion.div
